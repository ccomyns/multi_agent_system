    ...
    def run_codex(self, task: str, anchor_file: Path | None = None) -> None:
        ...
        if anchor_file is not None:
            ...
            anchor_instructions = (
                ...
                "more than twelve records in successive batches. The raw uploaded file is "
        ...
        developer_instructions = (
            ...
            "subagent. At most twelve subagents can be active "
            ...
            "collection tool. Once the accepted first batch of up to twelve agents has "
