...
class TelemetryRecorder:
    ...
    def __init__(
        ...
        *,
        ...
        self.completed_turn_usage: dict[str, int] = {}
        self.identity = {
            ...
            if event and event.get("type") == "turn.completed":
                for field in (*USAGE_FIELDS, "total_tokens"):
                    ...
                    if isinstance(value, int) and value >= 0:
                        self.completed_turn_usage[field] = self.completed_turn_usage.get(field, 0) + value
                usage = self.completed_turn_usage
    ...
    def publish(self, *, strict: bool) -> None:
        ...
        for path, key, content_type in (
            ...
            except Exception as error:  # Live telemetry must not kill the model process.
                errors.append(error)
